...
function Sidebar({ setComponent }) {
  ...
  return (
    <>
      ...
      <div
        className={`w-40 h-full shadow-lg fixed top-0 left-0 bg-gray-50 transition-transform duration-300 transform sm:translate-x-0 ${
...
Sidebar.propTypes = {
    setComponent: PropTypes.node.isRequired, // or PropTypes.node if not required
  };
